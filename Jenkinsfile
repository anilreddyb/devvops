///// Common variables /////
env.git_repo_name="git@https://github.com/anilreddyb/devvops" // update this value as created in Step 9 above
env.git_id="123"  // update this value as created in Step 9 above
